        ...
        schemas: {
          ...
          Beneficiary: {
            ...
            properties: {
              ...
              sort_code: { type: 'string', nullable: true },
          ...
          Withdrawal: {
            ...
            properties: {
              id: { type: 'string', format: 'uuid' },
              reference: { type: 'string', example: 'WDR-2026-000001' },
              user_id: { type: 'string', format: 'uuid' },
          ...
          Sabit: {
            ...
            properties: {
              ...
              available_amount: { type: 'string', example: '100.00' },
              rate_ngn: { type: 'string', example: '1500.00' },
              status: { $ref: '#/components/schemas/SabitStatus' },
              created_at: { type: 'string', format: 'date-time' },
            },
          },
          SabitType: {
          ...
          Trade: {
            ...
            properties: {
              ...
              rate_ngn: { type: 'string', example: '1500.00' },
              total_ngn: { type: 'string', example: '75000.00' },
              status: { $ref: '#/components/schemas/TradeStatus' },
              reference: { type: 'string', example: 'TRD-2026-000001' },
              created_at: { type: 'string', format: 'date-time' },
          ...
          TradeStatus: {
            type: 'string',
            enum: ['initiated', 'escrowed', 'confirmed', 'completed', 'cancelled', 'disputed'],
          },
          Dispute: {
            type: 'object',
            properties: {
              ...
              raised_by_id: { type: 'string', format: 'uuid' },
              reason: { type: 'string', example: 'Seller did not release funds' },
              status: { $ref: '#/components/schemas/DisputeStatus' },
              resolved_by_id: { type: 'string', format: 'uuid', nullable: true },
